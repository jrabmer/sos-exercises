...
@#$#@#$#@
<experiments>
  <experiment name="population-size" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    ...
    <enumeratedValueSet variable="fitness_function">
      <value value="&quot;Langermann&quot;"/>
      <value value="&quot;Schwefel&quot;"/>
      <value value="&quot;Shubert&quot;"/>
      <value value="&quot;Booth&quot;"/>
    </enumeratedValueSet>
  ...
  <experiment name="particle-speed-limit" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="particle-inertia" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="personal-confidence" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="swarm-confidence" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="population-size-nc" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="particle-speed-limit-nc" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="particle-inertia-nc" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="personal-confidence-nc" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
  ...
  <experiment name="swarm-confidence-nc" repetitions="1" runMetricsEveryStep="true">
    <setup>load</setup>
    <go>iterate</go>
    <timeLimit steps="200"/>
    <metric>global-best-val</metric>
